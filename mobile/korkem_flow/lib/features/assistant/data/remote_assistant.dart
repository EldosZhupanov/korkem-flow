      ...
      if (message.body.trim().isNotEmpty)
        {
          ...
          'text': message.body,
          // Происхождение сюда не уходит намеренно. Решает его сервер — он
          // один знает, кто написал. Поле, которое клиент может назвать сам,
          // рано или поздно кто-нибудь начнёт читать на той стороне, и тогда
          // «это от владельца» станет утверждением приложения, а не фактом.
        },
  ];
}
