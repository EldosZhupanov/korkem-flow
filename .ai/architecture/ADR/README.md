...
Produced per `.ai/architecture/adr_master_prompt.md`. This index lists every ADR and records the collective validation pass required by that prompt: checking the full set for contradictions, duplicated decisions, and missing decisions, and closing gaps found.
