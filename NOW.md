...
| | результат |
|---|---|
| `korkem_manufacturing` | **24 теста · OK** · 11.2 с |
| `korkem_ai` | **1052 теста · 1043 прошли · 0 падений · 0 ошибок · 9 skip** · 22 мин 27 с |
| Flutter `analyze` | **No issues found** |
| Flutter `format` | 196 файлов, 0 изменений |
| Flutter `test` | **365 прошли · 0 упало · 0 skip** · 3 мин 01 с |
