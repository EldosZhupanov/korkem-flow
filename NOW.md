...
| | результат |
|---|---|
| `korkem_manufacturing` | **24 теста · OK** · 27.9 с |
| `korkem_ai` | **1037 тестов · 1028 прошли · 0 падений · 0 ошибок · 9 skip** · 21 мин 53 с |
...
Оба бэкенд-набора зелёные **после** переноса `start_production`, не до него.
